...
5.7 
2025-08-05      Added Multinozzle configurations:750 GMN, 184 GMN, Mono
                MTG now also works with Even numbers of passes (rows & col)
                A Compact_Path parameter was added, for toolheads that require to add filaments in between already deposited filements (184 MN).
...
MLTNZL_CONFIG_184_GMN = {'name': '184 GMN', 'nb': 36, 'd': 0.250, 's': 0.684}
...
if myWindow.values:
    ...
    compact_path = compact_path == 'True'
...
if myWindow.values:
    ...
    if compact_path:
        pass_step_x = (pass_amplitude_x / segments_per_scaffold)/2
        pass_step_y = (pass_amplitude_y / segments_per_scaffold)/2
    ...
    is_even = (nb_rows % 2 == 0) and (nb_cols % 2 == 0)
